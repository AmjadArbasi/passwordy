...
class Routes {
  static List<GetPage<dynamic>>? getPages = [
    ...
    GetPage(
      name: AppRoutes.saveCatchword,
      page: () => const SaveCatchword(),
    ),
    GetPage(
      name: AppRoutes.viewCatchword,
      page: () => const CatchwordView(),
    ),
    GetPage(
      name: AppRoutes.saveCategory,
      page: () => const SaveCategory(),
    ),
    GetPage(
